                ...
                <div class="col-9">
                    <div class="d-flex flex-wrap">
                        <div class="col-12 col-sm-6 form-floating m-3" style="max-width: 300px">
                            <input 
                                type="text" 
                                :title="Err.User_Name_First ? 'Invalid First Name' : 'Enter First Name'" 
                                class="form-control" :class="{ 'is-invalid': Err.User_Name_First  }" 
                                id="firstName" 
                                v-model="User.User_Name_First" 
                                @focusout="validateInput('User_Name_First')" 
                                placeholder="Name"
                            >
                        ...
                        <div class="col-12 col-sm-6 form-floating m-3" style="max-width: 300px">
                            <input 
                                type="text" 
                                :title="Err.User_Name_Last ? 'Invalid Last Name' : 'Enter Last Name'" 
                                class="form-control" :class="{ 'is-invalid': Err.User_Name_Last  }"
                                id="lastName"
                                v-model="User.User_Name_Last"
                                @focusout="validateInput('User_Name_Last')" 
                                placeholder="Name"
                            >
...
export default {
    ...
    setup(props, { emit }){
        ...
        // Error Varaibles
        const Err = ref({
            User_Name_First: false,
            User_Name_Last: false,
            User_Name: false,
            Password: false,
        ...
        const clearForm = async () => {
            ...
            User.value.User_Name_First = null;
            User.value.User_Name_Last = null;
            User.value.User_Name = null;
            User.value.Password_Hash = null;
            User.value.Hash_Salt = null;
            User.value.Contact_Phone_Number = null;
            User.value.User_Email = null;
            Err.value.User_Name_First = false;
            Err.value.User_Name_Last = false;
