                ...
                <div v-for="service in activeServiceSchList" :key="service.id">
                  ...
                  >
                    ...
                    <div
                      v-if="
                        !(
                          service.App_Module == 'CORE' ||
                          service.App_Module == 'CURA'
                        )
                      "
                      class="versionSub serviceRemoveOption"
          ...
          >
            ...
            <div v-else>
              <div v-for="service in serviceList.slice(0,5)" :key="service.id">
                <div
                  class="d-flex flex-wrap justify-content-between align-items-center normalApp"
                >
                  <div class="d-flex flex-row align-items-center">
                    <div class="serviceIcon">
                      <font-awesome-icon :icon="service.App_Icon" size="1x" />
      ...
      sendSocketReq({
        ...
        callback: (res) => {
          if (res.Type === "RESPONSE") {
            ...
            // Active Services by default have CORE and CURA modules
            serviceList.value.forEach(service => {
              if(service.App_Module == "CORE" || service.App_Module == "CURA"){
                   activeServices.value.push(service);
                    // Assigning Active Services to UI
