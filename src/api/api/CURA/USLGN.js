...
module.exports.Authenticate_Username = async function (req, DBclient) {
  try {
    ...
    let userInfo = await DBclient.db(instituteCode).collection("User").findOne({ User_Name: req.Request.User_Name }, { projection: { _id: 0, ID_User: 1, User_Name_First: 1, User_Name_Last: 1, User_Group: 1, Hash_Salt: 1, User_Sex: 1, Flag_New_User: 1, Date_Time_Pwd_Expiry: 1, User_Profile: 1 } });
