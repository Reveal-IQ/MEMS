...
module.exports.Initialize_User = async function (req, DBclient) {
    try {
        ...
        let userInfo = await DBclient.db(instituteCode).collection("User").findOne({ ID_User: userID }, { projection: { _id: 0, User_Name_First: 1, User_Name_Middle: 1, User_Name_Last: 1, User_Name: 1, User_Sex: 1, User_Profile: 1, User_Group: 1, Hash_Salt: 1, User_Department: 1 } });
